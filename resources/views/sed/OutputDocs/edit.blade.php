...
@section('title', 'Редактирование исходящих документов')

@section('content')
    <div class="container">
        <h1>Редактирование исходящих документов</h1>
        <form action="/outputDocs/{{ $data->id }}/put" method="post" enctype="multipart/form-data">
            @csrf
