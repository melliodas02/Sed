...
@section('title', 'Добавление исходящих документов')

@section('content')
    <div class="container">
        <h1>Добавление исходящих документов</h1>
        <form action="{{ route('OutputDocs.save') }}" method="post" enctype="multipart/form-data">
            @csrf
