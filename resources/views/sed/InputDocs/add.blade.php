...
@section('title', 'Добавление входящих документов')

@section('content')
    <div class="container">
        <h1>Добавление входящих документов</h1>
        <form action="{{ route('inputDocs.save') }}" id="addDocs" method="post" enctype="multipart/form-data">
            @csrf
